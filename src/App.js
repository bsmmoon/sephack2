...
class App extends Component {
  constructor(props) {
    ...
    if (id == 2) {
      data = {
        banner: 'http://u-wantitblog.com/wp-content/uploads/2017/03/sephora-header.jpg',
        header: 'Admin Account Creation',
        subheader: 'step by step',
        headerColor: 'white',
      ...
      data = {
        banner: 'https://i.imgur.com/ScAasNC.png',
        header: 'How to Make Omelette',
        subheader: 'for the hungry souls',
        headerColor: 'black',
      ...
      data = {
        banner: 'http://u-wantitblog.com/wp-content/uploads/2017/03/sephora-header.jpg',
        header: 'New Hire Guide',
        subheader: 'welcome',
        headerColor: 'white',
        headerBackground: 'black',
        steps: [
          {
            title: 'Sign Up to Sephora.sg',
            type: 'link',
            message: 'Ask your neighbor for admin access',
            data: {
              link: 'https://www.sephora.sg/'
            }
          },
          {
            title: 'Personal Details Survey',
            type: 'google-form',
            message: 'Your data is safe with us',
            data: {
          ...
          },
          {
            title: 'Freshdesk',
            type: 'link',
            message: 'Ask your neighbor for access',
            data: {
              link: 'https://luxola.freshdesk.com/helpdesk'
            }
          },
          {
            title: 'How to create an admin account',
            type: 'link',
